...
@Component({
  selector: 'app-products-prueba',
  templateUrl: './products-prueba.component.html',
  styleUrls: ['./products-prueba.component.css']
})
export class ProductsPruebaComponent implements OnInit {
